...
<head>
    ...
    <title>CyberGuard — Cyberbullying Detection System</title>
...
<body class="text-white min-h-screen">
    ...
    <footer class="border-t border-cyan-900/20 mt-20 py-8">
        <div class="max-w-6xl mx-auto px-6 flex items-center justify-between text-xs text-gray-600">
            <span>© 2026 CyberGuard — CSIT 7th Semester Project</span>
            <span>ACHS College · DistilBERT 6-Class · 86% Accuracy</span>
        </div>
    </footer>
